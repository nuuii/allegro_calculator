...
export default function CalculatorPage({
  ...
  return (
    <div className="calculator-page">
        ...
        <div className="input-panel">
          ...
          <div className="currency-strip">
            <div style={{ display: "flex", gap: "0.25rem" }}>
              {currencies.map(c => (
                <button 
                  ...
                  style={{ 
                    background: purchaseCurrency === c.code ? "#f5a623" : "#22222e", 
                    color: purchaseCurrency === c.code ? "#0d0d11" : "#8a8a9e", 
                    borderRadius: "4px", 
            ...
            <div style={{ fontSize: "0.68rem" }}>
              {ratesLoading ? (
                <span style={{ color: "#6a6a82" }}>⟳ API...</span>
              ) : currentRate && purchaseCurrency !== "PLN" ? (
        ...
        <div className={`result-panel ${result ? (isPositive ? "is-positive" : isNegative ? "is-negative" : "") : ""}`}>
          {!result ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", height: "100%", justifyContent: "space-between", gap: "1rem" }}>
              <div>
                <div style={{ fontSize: "0.68rem", letterSpacing: "0.08em", color: "#6a6a82", marginBottom: "0.75rem", fontWeight: 600 }}>
                  STRUKTURA FINANSOWA
                </div>
              ...
              {result.profit !== undefined && (
                <div style={{ 
                  background: isPositive ? "#0f2214" : isNegative ? "#220f0f" : "#161622", 
                  borderRadius: "8px", 
      ...
      {/* === TABELA ZBIORCZA: Poza grid, pełna szerokość === */}
      <ResultsTable
